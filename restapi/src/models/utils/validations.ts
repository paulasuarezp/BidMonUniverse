...
const signupValidationSchema = yup.object({
    ...
    birthday: birthdayConstraints.required("Debe de introducir una fecha de nacimiento")
}).required();

export {
    birthdayConstraints, passwordConstraints, signupValidationSchema,
    usernameConstraints
};
